    ...
    fetch('https://bdc5dcf6bca04b39ab10a706cdb79f29.vfs.cloud9.us-east-1.amazonaws.com/occurrences/' + id_occurrence + '/materials_utilizations')
        ...
        .then((out) => {
            ...
            $.each(out, function(index, value) {
                ...
                $('#table tbody').append('<tr class="fullRow"><th class ="id_vei_mat" scope="row">' + value.id_vei_mat + '</th><td>' + value.material_type + '</td> <td>  <label class="checkboxConfirmMaterials" tab-index="0" aria-label="Checkbox Label"> <input class="utilization"type="checkbox" checked> <span class="checkmark"></span> </label> </td> </tr>')
            });
            console.log(obj);

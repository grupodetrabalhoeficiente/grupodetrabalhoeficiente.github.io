        ...
        .then((out) => {
            ...
            $.each(out, function(index, value) {
                if (value.statute !== "chefe") {
                    ...
                    $('#table tbody').append('<tr class="fullRow"><th class ="id_operational"scope="row">' + value.id_operational + '</th><td>' + value.name + '</td> <td>  <label class="checkboxOperationals" tab-index="0" aria-label="Checkbox Label"> <input class="presence"type="checkbox" checked> <span class="checkmark"></span> </label> </td> </tr>')
                } else {
                    obj.push({ "id_operational": value.id_operational });
                    $('#table tbody').append('<tr class="fullRow"><th class ="id_operational"scope="row">' + value.id_operational + '</th><td>' + value.name + '</td> <td>  <label class="checkboxOperationals" tab-index="0" aria-label="Checkbox Label"> <input class="presence"type="checkbox" disabled checked> <span class="checkmark"></span> </label> </td> </tr>')
                }
...
function updatePresence() {
    ...
    window.location.replace("../html/MenuOcorrencia.html");
}
